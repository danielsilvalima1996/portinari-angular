 ...
 *
 * Pode ser utilizado para dar feedback das ações do usuário como por exemplo, erro de autorização, mensagens de regras de negocio,
 ...
 * ## Como usar
 *
 * Para exibir a notificações é necessário informar o objeto `_messages` retornado pela requisição de sucesso `2xx`.
 *
 * Os retornos de erros com códigos `4xx` e `5xx` são tratados automaticamente, sem a necessidade de incluir o `_messages`,
 * veja nos tópicos abaixo a estrutura de dados possível a ser informada.
 *
